...
try {
    $response1 = Invoke-RestMethod -Uri "$API_URL/loads/smart-search" `
        -Method Post -Body $body1 -ContentType "application/json"
    
    Write-Host "✅ Test 7.1 PASSED" -ForegroundColor Green
    ...
    if ($response1.chains.Count -gt 0) {
        Write-Host "`n   Top Chain:" -ForegroundColor Cyan
    ...
    Write-Host "❌ Test 7.1 FAILED" -ForegroundColor Red
...
try {
    $response2 = Invoke-RestMethod -Uri "$API_URL/loads/smart-search" `
        -Method Post -Body $body2 -ContentType "application/json"
    
    Write-Host "✅ Test 7.2 PASSED" -ForegroundColor Green
    ...
    if ($response2.directLoads.Count -gt 0) {
        Write-Host "`n   Top Direct Load:" -ForegroundColor Cyan
    ...
    Write-Host "❌ Test 7.2 FAILED" -ForegroundColor Red
    Write-Host "   Error: $($_.Exception.Message)" -ForegroundColor Red
    if ($_.ErrorDetails.Message) {
        Write-Host "   Details: $($_.ErrorDetails.Message)" -ForegroundColor Red
    }
...
try {
    $response3 = Invoke-RestMethod -Uri "$API_URL/loads/smart-search" `
        -Method Post -Body $body3 -ContentType "application/json"
    
    Write-Host "✅ Test 7.3 PASSED" -ForegroundColor Green
    ...
    Write-Host "❌ Test 7.3 FAILED" -ForegroundColor Red
    Write-Host "   Error: $($_.Exception.Message)" -ForegroundColor Red
    if ($_.ErrorDetails.Message) {
        Write-Host "   Details: $($_.ErrorDetails.Message)" -ForegroundColor Red
    }
...
try {
    $response4 = Invoke-RestMethod -Uri "$API_URL/loads/smart-search" `
        -Method Post -Body $body4 -ContentType "application/json"
    
    Write-Host "✅ Test 7.4 PASSED" -ForegroundColor Green
    ...
    if ($allLoads.Count -gt 0) {
        Write-Host "`n   Equipment Breakdown:" -ForegroundColor Cyan
    ...
    Write-Host "❌ Test 7.4 FAILED" -ForegroundColor Red
    Write-Host "   Error: $($_.Exception.Message)" -ForegroundColor Red
    if ($_.ErrorDetails.Message) {
        Write-Host "   Details: $($_.ErrorDetails.Message)" -ForegroundColor Red
    }
...
try {
    $response5 = Invoke-RestMethod -Uri "$API_URL/loads/smart-search" `
        -Method Post -Body $body5 -ContentType "application/json"
    
    Write-Host "✅ Test 7.5 PASSED" -ForegroundColor Green
    ...
    Write-Host "`n   Market Insight:" -ForegroundColor Cyan
    ...
    Write-Host "❌ Test 7.5 FAILED" -ForegroundColor Red
    Write-Host "   Error: $($_.Exception.Message)" -ForegroundColor Red
    if ($_.ErrorDetails.Message) {
        Write-Host "   Details: $($_.ErrorDetails.Message)" -ForegroundColor Red
    }
...
try {
    $response6 = Invoke-RestMethod -Uri "$API_URL/loads/smart-search" `
        -Method Post -Body $body6 -ContentType "application/json"
    
    Write-Host "✅ Test 7.6 PASSED" -ForegroundColor Green
    ...
    if ($response6.chains.Count -gt 0) {
        ...
        Write-Host "`n   Chain Scores:" -ForegroundColor Cyan
        ...
        Write-Host "`n   Verifying Chain Score Calculation:" -ForegroundColor Cyan
    ...
    Write-Host "❌ Test 7.6 FAILED" -ForegroundColor Red
    Write-Host "   Error: $($_.Exception.Message)" -ForegroundColor Red
    if ($_.ErrorDetails.Message) {
        Write-Host "   Details: $($_.ErrorDetails.Message)" -ForegroundColor Red
    }
